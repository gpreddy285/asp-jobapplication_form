<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="experienced.aspx.cs" Inherits="job_application_form_inasp.experienced" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 align="center" style="color:blue;">Welcome To Experienced IT Job Application Form</h1>
...
Select Branch  <asp:DropDownList ID="ddlcbranch" runat="server">
  ...
  Other Skills:<textarea id="txtareaothers" runat="server"></textarea><br /><br />
            <!--experience details-->
            <h2 align="left" style="color:brown;">Experience Details</h2>
            Company name:<asp:TextBox ID="txtcompname" runat="server"></asp:TextBox><br /><br />
            Company Website:<asp:TextBox ID="txtcompweb" runat="server"></asp:TextBox><br /><br />
            Company Phone number<asp:TextBox ID="txtcompphno" runat="server"></asp:TextBox><br /><br />
            Company Address<asp:TextBox ID="txtcompadd" runat="server"></asp:TextBox><br /><br />
            Designation<asp:TextBox ID="txtcompdesi" runat="server"></asp:TextBox><br /><br />
            Current CTC<asp:TextBox ID="txtcompctc" runat="server"></asp:TextBox><br /><br />
